      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the AI chatbot ("Chatbot") provided by Emma Tillitski ("Provider"), you acknowledge that you have read, understood, and
          ...
          <li className="text-gray-700">
            ...
            or implied. Emma Tillitski makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Emma Tillitski does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Emma Tillitski shall not be
            ...
            Emma Tillitski has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Emma Tillitski is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Emma Tillitski does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Emma Tillitski from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Emma Tillitski
          ...
          <li className="text-gray-700">
            ...
            contact Emma Tillitski at emma_tillitski@kenan-flagler.unc.edu.
          </li>
        </ol>
      </div>
    </div>
